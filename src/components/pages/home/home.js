...
const Home = () => {
 ...
 <div style={{
  background:'blue'
    ...
    {/* <a className="tooltip tooltip-right navLink" data-tip="Home"> */}
     <Link to='/' >
...
<div className='ml-4 mt-4 first'>
    <h1 className='text-2xl font-link font-bold'>Hi Mike,</h1>
    <h1 className='pera-link'>Welcome back</h1>
</div>
       </div>
       <div className='mt-8'>
        <p className='font-bold mb-2'>Today</p>
        <h1 className='font-link font-bold text-xl'>$19,892</h1>
        <p style={{
          color:'gray'
        }}>Account Balance</p>
        <p className='font-bold font-link mt-2'>$4000</p>
        <p style={{
          color:'gray'
        }}>Year-to-Date Contribution</p>
        <h1 className='font-bold font-link mt-2'>$1,892</h1>
        <p style={{
          color:'gray'
        }}>Total Interest</p>
        <button style={{
            width:100
        }} className='btn-primary rounded-lg text-white mt-4  p-2'>I want to
       </button>
       </div>
       <div className='mt-16'>
        <h1 className='font-bold pera-link'>Recent Transaction</h1>
        <p style={{
          color:'gray'
        }} className='mt-6'>2020-08-07</p>
        <p className='pera-link font-bold'>Withdrawal Transfer to Bank-XXX11</p>
        ...
        <div className='p-16'>
            ...
            <div className='grid grid-cols-3 gap-8 mt-4'>
                <div className='mr-6'>
                    <h1  className='font-bold'>$30,0000</h1>
                    <p style={{
                      color:'gray'
                    }}>My Goal</p>
                    <div className='divider'></div>
...
<div className="radial-progress text-success" style={{"--value":59}}>59%</div>
      ...
      <div>
      <div className='p-10 employee bg-base-200 mt-16 ml-16  rounded-lg'>
            <h1 className='font-bold pera-link mb-4'>Retirement Strategy</h1>
            <p className='mb-2'>Employee Contribution</p>
            <div className='flex mb-6'>
            <input type="range" min={0} max="100" value="40" className="range range-info" />
            <h1 style={{
              background:'white'
            }} className='ml-2 font-bold'>12%</h1>
            </div>
            ...
            <h1 style={{
              background:'white'
            }} className='ml-2 p-1 font-bold'>65</h1>
            </div>
            <div className='divider'></div>
            <div>
       <div className='flex '>
            <h1 className='mr-6 font-bold'>Employer Contribution</h1>
            <h1 className='font-bold'>8.4%</h1>
        </div>
        <div className='flex '>
            <h1 className='mr-6 font-bold'>Interest Rate</h1>
            <h1 className='font-bold'>5%</h1>
        </div>
       </div>
       <button style={{
        width:220
       }} className='btn btn-primary mt-4 text-white updateButton'>Update</button>
       <h1 className='text-primary mt-4 ml-8'>View help docs</h1>
        </div>
        <div className='flex mt-8 lastSection ml-10'>
        <div className="divider lg:divider-horizontal"></div> 
        <div >
            <h1>Are you considering a <span className='font-bold'>Housing Advance?</span></h1>
            <p style={{
              color:'gray'
            }}>Limited time reduced interest</p>
